...
if [ ! -e "data/corpus.nl" ]
then
    ./scripts/download-files-dutch.sh
fi

mkdir -p model

# preprocess data
if [ ! -e "data/corpus.bpe.nl" ]
then
...
then
    $MARIAN_TRAIN \
        ...
        --train-sets data/corpus.bpe.nl data/corpus.bpe.de \
        --vocabs model/vocab.nl.yml model/vocab.de.yml \
        ...
        --valid-sets data/corpus-dev.bpe.nl data/corpus-dev.bpe.de \
...
../tools/moses-scripts/scripts/generic/multi-bleu-detok.perl data/corpus-dev.de < data/corpus-dev.nl.output
../tools/moses-scripts/scripts/generic/multi-bleu-detok.perl data/corpus-test.de < data/corpus-test.nl.output